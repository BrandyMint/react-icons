...
var TiDocument = function (_React$Component) {
    _inherits(TiDocument, _React$Component);

    function TiDocument() {
        _classCallCheck(this, TiDocument);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(TiDocument).apply(this, arguments));
    }

    _createClass(TiDocument, [{
        key: 'render',
