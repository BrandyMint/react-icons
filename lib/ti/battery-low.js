...
var TiBatteryLow = function (_React$Component) {
    _inherits(TiBatteryLow, _React$Component);

    function TiBatteryLow() {
        _classCallCheck(this, TiBatteryLow);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(TiBatteryLow).apply(this, arguments));
    }

    _createClass(TiBatteryLow, [{
        key: 'render',
