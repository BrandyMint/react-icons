...
var MdEmail = function (_React$Component) {
    _inherits(MdEmail, _React$Component);

    function MdEmail() {
        _classCallCheck(this, MdEmail);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(MdEmail).apply(this, arguments));
    }

    _createClass(MdEmail, [{
        key: 'render',
