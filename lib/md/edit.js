...
var MdEdit = function (_React$Component) {
    _inherits(MdEdit, _React$Component);

    function MdEdit() {
        _classCallCheck(this, MdEdit);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(MdEdit).apply(this, arguments));
    }
