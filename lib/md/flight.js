...
var MdFlight = function (_React$Component) {
    _inherits(MdFlight, _React$Component);

    function MdFlight() {
        _classCallCheck(this, MdFlight);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(MdFlight).apply(this, arguments));
    }

    _createClass(MdFlight, [{
        key: 'render',
