...
var MdMood = function (_React$Component) {
    _inherits(MdMood, _React$Component);

    function MdMood() {
        _classCallCheck(this, MdMood);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(MdMood).apply(this, arguments));
    }
