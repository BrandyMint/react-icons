...
var MdBackup = function (_React$Component) {
    _inherits(MdBackup, _React$Component);

    function MdBackup() {
        _classCallCheck(this, MdBackup);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(MdBackup).apply(this, arguments));
    }

    _createClass(MdBackup, [{
        key: 'render',
