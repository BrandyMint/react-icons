...
var MdFilter5 = function (_React$Component) {
    _inherits(MdFilter5, _React$Component);

    function MdFilter5() {
        _classCallCheck(this, MdFilter5);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(MdFilter5).apply(this, arguments));
    }

    _createClass(MdFilter5, [{
        key: 'render',
