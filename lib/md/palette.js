...
var MdPalette = function (_React$Component) {
    _inherits(MdPalette, _React$Component);

    function MdPalette() {
        _classCallCheck(this, MdPalette);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(MdPalette).apply(this, arguments));
    }

    _createClass(MdPalette, [{
        key: 'render',
