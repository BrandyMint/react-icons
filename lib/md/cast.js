...
var MdCast = function (_React$Component) {
    _inherits(MdCast, _React$Component);

    function MdCast() {
        _classCallCheck(this, MdCast);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(MdCast).apply(this, arguments));
    }
