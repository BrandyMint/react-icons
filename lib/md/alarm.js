...
var MdAlarm = function (_React$Component) {
    _inherits(MdAlarm, _React$Component);

    function MdAlarm() {
        _classCallCheck(this, MdAlarm);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(MdAlarm).apply(this, arguments));
    }
