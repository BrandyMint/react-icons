...
var MdIso = function (_React$Component) {
    _inherits(MdIso, _React$Component);

    function MdIso() {
        _classCallCheck(this, MdIso);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(MdIso).apply(this, arguments));
    }
