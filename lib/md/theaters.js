...
var MdTheaters = function (_React$Component) {
    _inherits(MdTheaters, _React$Component);

    function MdTheaters() {
        _classCallCheck(this, MdTheaters);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(MdTheaters).apply(this, arguments));
    }

    _createClass(MdTheaters, [{
        key: 'render',
