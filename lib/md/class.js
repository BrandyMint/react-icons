...
var MdClass = function (_React$Component) {
    _inherits(MdClass, _React$Component);

    function MdClass() {
        _classCallCheck(this, MdClass);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(MdClass).apply(this, arguments));
    }

    _createClass(MdClass, [{
        key: 'render',
